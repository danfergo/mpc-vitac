...
class GelTipInterfaceMJC:
    ...
    def __init__(self,
        ...
        try:
            ...
            real_bkg = cv2.imread(os.path.join(__location__, 'sim_assets/bkg.png'))
            ...
            self.model = SimulationModel(**{
                ...
                'background_depth': np.load(os.path.join(__location__, 'sim_assets/bkg.npy')),
                # 'cloud_map': cloud,
                'rectify_fields': True,
                'background_img': real_bkg,
    ...
    def read(self):
        ...
        self.tactile = (self.model.generate(depth) * self.mask) \
            .astype(np.uint8)
        return self.tactile
    ...
    template="""
        <mujoco>
            <asset>
                ...
                <mesh name="geltip_elastomer_inv" file="meshes/elastomer_inv.stl" scale="0.001 0.001 0.001"/>
